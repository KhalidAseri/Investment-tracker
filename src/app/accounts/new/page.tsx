...
export default function NewAccountPage() {
  ...
  const [form, setForm] = useState({
    name: '', nameAr: '', type: ACCOUNT_TYPES.SAUDI_STOCKS as string, currency: 'SAR', description: '',
  })
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {(Object.keys(ACCOUNT_CONFIGS) as AccountType[]).map((type) => {
              ...
              return (
                <button key={type} type="button" onClick={() => setForm({ ...form, type, name: config.label.en, nameAr: config.label.ar })}
